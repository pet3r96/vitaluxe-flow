-- Fix notification triggers by removing the 'category' column

-- Drop and recreate notify_follow_up_assignment without category column
...
-- Drop and recreate notify_follow_up_scheduled without category column
