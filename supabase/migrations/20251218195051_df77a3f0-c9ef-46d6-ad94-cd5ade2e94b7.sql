-- Fix notify_patient_of_appointment_update function to use start_time instead of scheduled_time
...
BEGIN
  ...
  IF TG_OP = 'INSERT' THEN
    ...
    v_scheduled_time := NEW.start_time;  -- FIXED: was NEW.scheduled_time
