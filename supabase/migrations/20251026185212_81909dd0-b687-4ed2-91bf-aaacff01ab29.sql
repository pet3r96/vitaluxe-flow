-- Fix rep_earnings_view to include downline reps
DROP VIEW IF EXISTS rep_earnings_view;

-- Recreate with separate rows for topline and downline
...
-- Downline commissions (separate rows for downline reps)
SELECT 
  op.id,
  op.created_at,
  'product_commission' as earning_type,
