-- Add downline_count to rep_productivity_summary materialized view
...
SELECT 
  ...
  -- Count downlines for this topline
  (SELECT COUNT(*) 
   FROM reps downline_reps 
   WHERE downline_reps.assigned_topline_id = r.id 
   AND downline_reps.role = 'downline') as downline_count,
