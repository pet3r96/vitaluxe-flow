...
DROP POLICY IF EXISTS "Staff can view their practice patients" ON public.patient_accounts;
DROP POLICY IF EXISTS "Staff can update their practice patients" ON public.patient_accounts;
...
DROP POLICY IF EXISTS "Staff can create follow-ups for their patients" ON public.patient_follow_ups;
DROP POLICY IF EXISTS "Providers can create follow-ups for their patients" ON public.patient_follow_ups;
DROP POLICY IF EXISTS "Staff can update their practice follow-ups" ON public.patient_follow_ups;
DROP POLICY IF EXISTS "Providers can update their practice follow-ups" ON public.patient_follow_ups;
