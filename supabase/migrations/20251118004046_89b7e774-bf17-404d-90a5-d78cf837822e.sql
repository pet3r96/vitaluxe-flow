-- Fix column order in archive_all_logs() error logs archival
-- Bug: Columns were in wrong order causing UUID type mismatch
...
BEGIN
  ...
  BEGIN
    ...
    -- 2. Archive old medical vault logs (90 days)
    ...
    -- 3. Archive error logs from audit_logs (90 days) - FIXED COLUMN ORDER
    ...
    -- 5. Purge old video sessions (30 days)
