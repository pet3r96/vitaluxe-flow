-- Drop and recreate get_effective_product_price to fix upline_id → assigned_topline_id
...
RETURNS TABLE(topline_price numeric, downline_price numeric, retail_price numeric, base_price numeric)
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
  ...
  IF v_downline_rep_id IS NOT NULL THEN
    ...
    INTO v_override_topline, v_override_downline, v_override_retail
  ...
  RETURN QUERY SELECT v_override_topline, v_override_downline, v_override_retail, v_product.base_price;
END;
$$;