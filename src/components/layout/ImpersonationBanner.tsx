...
export function ImpersonationBanner() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-primary/90 to-accent/90 shadow-gold animate-in slide-in-from-top">
      <div className="container mx-auto px-2 sm:px-4 py-1 sm:py-1.5 flex items-center justify-between gap-2 max-w-full overflow-hidden">
        <div className="flex items-center gap-1 sm:gap-1.5 min-w-0 flex-1">
          <Eye className="h-3 w-3 sm:h-3.5 sm:w-3.5 flex-shrink-0 text-white" />
          <span className="text-[10px] sm:text-xs font-medium truncate text-white">
        ...
        <Button
          ...
          className="h-6 sm:h-7 py-0.5 px-1.5 sm:px-2 text-[10px] sm:text-xs text-white hover:bg-white/20 flex-shrink-0"
        >
