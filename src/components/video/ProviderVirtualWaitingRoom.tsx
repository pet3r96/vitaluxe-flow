...
export const ProviderVirtualWaitingRoom = ({ practiceId, onStartSession }: ProviderVirtualWaitingRoomProps) => {
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground flex items-center gap-2">
                    ...
                    {isPatientWaiting && (
                      <span className="text-green-600 dark:text-green-400 font-medium">• Patient waiting</span>
                    )}
                  </div>
                </div>
              </div>
      ...
      <AlertDialog open={showCompleteDialog} onOpenChange={setShowCompleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Mark this video appointment as completed? The appointment will be removed from your waiting room and
              archived.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
