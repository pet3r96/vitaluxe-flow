...
export function PatientQuickSearch() {
  ...
  return (
    <>
      <Button
        variant="outline"
        className="relative w-full justify-start text-sm text-muted-foreground h-9 sm:h-10"
        onClick={() => setOpen(true)}
      >
        <Search className="mr-2 h-4 w-4 shrink-0" />
        <span className="hidden sm:inline-flex truncate">Search patients...</span>
        <span className="inline-flex sm:hidden truncate">Search...</span>
